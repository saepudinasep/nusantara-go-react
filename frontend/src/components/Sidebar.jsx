...
const MENUS = {
  admin: [
    ...
    { name: 'Transaksi Pembayaran', icon: 'check', route: '/admin/transaksi' },
    { name: 'Laporan', icon: 'laporan', route: '/admin/laporan' },
  ...
  petugas: [
    ...
    { name: 'Laporan', icon: 'laporan', route: '/petugas/laporan' },
